...
CREATE TABLE `userextends`  (
  ...
  `JRegisterID` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `CreateUserID` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `CreateTime` datetime(0) NULL,
  `ModifyUserID` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `ModifyTime` datetime(0) NULL DEFAULT NULL,
...
CREATE TABLE `users`  (
  `UserID` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `UserAccount` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `PayPassword` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  ...
  `IsTestAccount` tinyint(1) NOT NULL,
  `TestEndDate` datetime(0) NULL DEFAULT NULL,
  `Terminal` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `OrgCode` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `RegisterType` int(11) NOT NULL,
  `ExpiredTime` datetime(0) NULL DEFAULT NULL,
  `CreateUserID` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `CreateTime` datetime(0) NULL,
  `ModifyUserID` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `ModifyTime` datetime(0) NULL DEFAULT NULL,
