    ...
    {      
        ...
        private bool GetSignVeryfy(SortedDictionary<string, string> inputPara, string sign)
        {
            ...
            if (sign != null && sign != "")
            {
                ...
                {
                    case "MD5":
                        isSgin = AlipayMD5.Verify(preSignStr, sign, _key, define.input_charset);
                        break;
                    default:
                        break;
                }
        ...
        {
            string veryfy_url = define.Https_veryfy_url + "partner=" + _partner + "&notify_id=" + notify_id;
