...
namespace XuHos.Common.Pay.WxPay
{
    internal class RefundQuery
    {
        ...
        * @return 退款查询结果（xml格式）
        */
        public static string Run(string refund_id, string out_refund_no, string transaction_id, string out_trade_no,string appId)
        {
            ...
            WxPayData result = WxPayApi.RefundQuery(data,6,appId);//提交退款查询给API，接收返回数据
