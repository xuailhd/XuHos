...
namespace KMEHosp.Common.Pay.WxPay
{
    public class OrderQuery
    {
        ...
        * @return 订单查询结果（xml格式）
        */
        public static WxPayData Run(string transaction_id, string out_trade_no,string appId)
        {
            ...
            WxPayData result = WxPayApi.OrderQuery(data,6,appId);//提交订单查询请求给API，接收返回数据
