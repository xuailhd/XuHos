...
namespace XuHos.Common.Pay.WxPay
{
    ...
    {
        public delegate bool UpdateOrderStateHandler(string OrderNo,string TradeNo);
        ...
        public virtual void ProcessNotify(UpdateOrderStateHandler UpdateOrderState, string appId)
        {
