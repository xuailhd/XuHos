...
namespace XuHos.Common.Pay.WxPay
{
    internal class WxPayApi
    {
        //=======【商户系统后台机器IP】===================================== 
        /* 此参数可手动配置也可在程序中自动获取        */
        public static string IP = "112.74.101.192";
        ...
        */
        public static WxPayData Micropay(WxPayData inputObj, int timeOut, string appId)
        {
            ...
            ReportCostTime(url, timeCost, result,appId);//测速上报
        ...
        */
        public static WxPayData OrderQuery(WxPayData inputObj, int timeOut, string appId)
        {
            var WxPayConfig = Configuration.GetAppPayConfig<Config.Sections.Pay.WXPay>(appId);
            if (WxPayConfig != null)
            {
            ...
            {
                throw new Exception("微信支付配置错误,appId=" + appId);
            }
        }
        ...
        */
        public static WxPayData Reverse(WxPayData inputObj, int timeOut,string appId)
        {
            var WxPayConfig = Configuration.GetAppPayConfig<Config.Sections.Pay.WXPay>(appId);
        ...
        */
        public static WxPayData Refund(WxPayData inputObj, int timeOut,string appId)
        {
            var WxPayConfig = Configuration.GetAppPayConfig<Config.Sections.Pay.WXPay>(appId);
	    ...
	    * @return 成功时返回，其他抛异常
	    */
	    public static WxPayData RefundQuery(WxPayData inputObj, int timeOut,string appId)
	    {
            var WxPayConfig = Configuration.GetAppPayConfig<Config.Sections.Pay.WXPay>(appId);
        ...
        * @return 成功时返回，其他抛异常
        */
        public static WxPayData DownloadBill(WxPayData inputObj, int timeOut,string appId)
        {
            var WxPayConfig = Configuration.GetAppPayConfig<Config.Sections.Pay.WXPay>(appId);
	    ...
	    * @return 成功时返回，其他抛异常
	    */
	    public static WxPayData ShortUrl(WxPayData inputObj, int timeOut,string appId)
	    {
            var WxPayConfig = Configuration.GetAppPayConfig<Config.Sections.Pay.WXPay>(appId);
        ...
        * @return 成功时返回，其他抛异常
        */
        public static WxPayData UnifiedOrder(WxPayData inputObj, int timeOut, string appId)
        {
            var WxPayConfig = Configuration.GetAppPayConfig<Config.Sections.Pay.WXPay>(appId);

            string NOTIFY_URL = string.Format("{0}/Cashier/WxPay/NotifyUrl?SellerID={1}", Configuration.Config.NotifyUrlPrefix, WxPayConfig.APPID);
	    ...
	    * @return 成功时返回，其他抛异常
	    */
	    public static WxPayData CloseOrder(WxPayData inputObj, int timeOut ,string appId)
	    {
            var WxPayConfig = Configuration.GetAppPayConfig<Config.Sections.Pay.WXPay>(appId);
	    ...
	    */
        private static void ReportCostTime(string interface_url, int timeCost, WxPayData inputObj,string appId)
	    {
            var WxPayConfig = Configuration.GetAppPayConfig<Config.Sections.Pay.WXPay>(appId);
	    ...
	    */
	    public static WxPayData Report(WxPayData inputObj, int timeOut, string appId)
	    {
            var WxPayConfig = Configuration.GetAppPayConfig<Config.Sections.Pay.WXPay>(appId);
